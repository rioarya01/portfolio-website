<template>
    <!-- Dark Mode -->
    <div class="inset-0 cursor-pointer items-center rounded-sm ml-2.5 md:ml-5">
        <!-- Light Icon -->
        <svg
            class="m-auto fill-current light-icon w-5 md:w-6 h-auto"
        ...
        <!-- Dark Icon -->
        <svg
            class="m-auto fill-current dark-icon w-5 md:w-6 h-auto dark:text-yellow-400"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 96 960 960"
        >
            <path
            d="M480 936q-150 0-255-105T120 576q0-150 105-255t255-105q14 0 27.5 1t26.5 3q-41 29-65.5 75.5T444 396q0 90 63 153t153 63q55 0 101-24.5t75-65.5q2 13 3 26.5t1 27.5q0 150-105 255T480 936Z"
            />
        </svg>
    </div>
</template>